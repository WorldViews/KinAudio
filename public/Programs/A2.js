...
var A2 = class extends AudioProgram {
    ...
    initGUI() {
        ...
        gui.add(this, 'loadAudio');
        gui.add(this, 'addFilter');
        gui.add(this, 'removeFilter');
    }
    ...
    changeFilterFrequency() {
        if (this.audioEffects.biquad == null) {
            ...
            this.audioEffects.biquad.frequency.value = this.freq;
        }
    }
    ...
    changeFilterQ() {
        if (this.audioEffects.biquad == null) {
            ...
            console.log("new frequency value: ", this.q);
            this.audioEffects.biquad.Q.value = this.q;
        }
    }
